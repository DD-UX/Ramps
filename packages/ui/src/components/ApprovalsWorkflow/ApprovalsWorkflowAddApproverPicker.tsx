...
import { type ApprovalsRole, type ApprovalsUser, membersOfRole } from './stageHelpers';

/**
 * ApprovalsWorkflowAddApproverPicker — the "＋ Add approver" row and the picker it opens
 ...
 */
export interface ApprovalsWorkflowAddApproverPickerProps {
  roles: ApprovalsRole[];
  users: ApprovalsUser[];
...
export function ApprovalsWorkflowAddApproverPicker({
  roles,
  users,
  onAdd,
}: ApprovalsWorkflowAddApproverPickerProps) {
