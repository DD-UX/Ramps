...
// The tab title mirrors the SideMenu label for this route ("Accounting").
export const metadata: Metadata = {
  title: 'Accounting — Ramps',
};

// Accounting is a nav destination but not the focus of this build — like every
