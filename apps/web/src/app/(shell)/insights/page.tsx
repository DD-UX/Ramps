...
// The tab title mirrors the SideMenu label for this route ("Insights").
export const metadata: Metadata = {
  title: 'Insights — Ramps',
};

// Insights is a nav destination but not the focus of this build — like every
